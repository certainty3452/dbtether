...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BackupJobConfig) DeepCopyInto(out *BackupJobConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackupJobConfig.
func (in *BackupJobConfig) DeepCopy() *BackupJobConfig {
	if in == nil {
		return nil
	}
	out := new(BackupJobConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DatabaseUserStatus) DeepCopyInto(out *DatabaseUserStatus) {
	*out = *in
	if in.Databases != nil {
		in, out := &in.Databases, &out.Databases
		*out = make([]DatabaseAccessStatus, len(*in))
		copy(*out, *in)
	}
